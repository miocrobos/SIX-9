  ...
  return (
    ...
    >
      {others.map((other) => {
        ...
        // The AI participant moves in sparse jumps; smooth it so it glides
        // between placements like a real collaborator building the map.
        const isAi = other.id === "sense-ai" || other.info?.name === "Sense AI"
        ...
        return (
          <div
            ...
            style={{
              left: x,
              top: y,
              transition: isAi ? "left 0.45s ease-out, top 0.45s ease-out" : undefined,
            }}
          >
            <svg
              width="16"
