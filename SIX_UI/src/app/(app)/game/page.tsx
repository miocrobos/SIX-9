        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
          <h1 className="text-2xl md:text-3xl font-black text-[#1A1A1A] dark:text-white">Know Game</h1>
                <p className="text-gray-500 text-sm">Test your SIX knowledge. Earn XP. Climb the ranks.</p>
              </div>
            </div>
          </div>
          <div className="flex gap-2 md:gap-3">
            <Card className="px-3 md:px-4 py-2 md:py-3 text-center">
              <p className="text-xs text-gray-500 mb-0.5">Your Best</p>
              <p className="text-lg md:text-xl font-black text-[#D92525]">91%</p>
            </Card>
            <Card className="px-3 md:px-4 py-2 md:py-3 text-center">
              <p className="text-xs text-gray-500 mb-0.5">Games</p>
              <p className="text-lg md:text-xl font-black text-[#1A1A1A] dark:text-white">24</p>
            </Card>
            <Card className="px-3 md:px-4 py-2 md:py-3 text-center hidden sm:block">
              <p className="text-xs text-gray-500 mb-0.5">XP from Games</p>
              <p className="text-lg md:text-xl font-black text-[#58CC02]">2,140</p>
            </Card>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-[#1A1A1A] dark:text-white text-sm">Top Players</h3>
            ...
            <div className="space-y-3">
              {topPlayers.map(p => (
                <div key={p.rank} className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-[#1A1A1A] dark:text-white flex-1 font-medium">{p.name}</span>
          ...
          {/* Recent Games */}
          <Card className="p-5">
            <h3 className="font-bold text-[#1A1A1A] dark:text-white text-sm mb-4">Recent Games</h3>
            <div className="space-y-3">
              {recentScores.map((g, i) => (
                <div key={i} className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-[#1A1A1A] dark:text-white font-medium">{g.mode}</p>
          ...
          <Card className="p-5 bg-gradient-to-br from-[#D92525]/10 to-[#CE82FF]/5 border border-[#D92525]/20">
            ...
            <p className="font-bold text-[#1A1A1A] dark:text-white mb-1">SIX Note</p>
