        ...
        <div className={cn('space-y-6', className)}>
            ...
            >
                ...
                <div className="space-y-4">
                    <h4 className="text-sm font-medium text-[#777]">SIX Financial Information</h4>
                    <div className="voice-selector-options">
                        {voiceCategories.financialInformation.map((voiceId) => {
                ...
                {/* Innovation Hub */}
                <div className="space-y-4">
                    <h4 className="text-sm font-medium text-[#777]">Innovation Hub</h4>
                    <div className="voice-selector-options">
                        {voiceCategories.innovationHub.map((voiceId) => {
                            const voice = voiceOptions[voiceId as keyof typeof voiceOptions];
                            const isSelected = value === voiceId;
                            return (
                                <Label
