            ...
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    <div className="library-hero-text">
                        <h1 className="library-hero-title text-4xl font-serif font-bold">The Company Brain</h1>
                        <p className="library-hero-description">
                            Turn SIX expert knowledge into traceable AI conversations. <br className="hidden md:block" />
                            Capture, contextualize, and reuse critical expertise.
                        </p>
                        <Link href="/books/new" className="library-cta-primary mt-4 flex items-center justify-center">
                            ...
                            <span className="text-[#212a3b]">Add knowledge</span>
                        </Link>
                    </div>
                        ...
                        <ul className="space-y-6">
                            <li className="library-step-item">
                                ...
                                <div className="flex flex-col">
                                    <h3 className="library-step-title text-lg font-bold">Upload Document</h3>
                                    <p className="library-step-description text-gray-500">Add your knowledge source</p>
                                </div>
                            </li>
                            <li className="library-step-item">
