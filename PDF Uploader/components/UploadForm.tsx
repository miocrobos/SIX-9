    ...
    const onSubmit = async (data: BookUploadFormValues) => {
        ...
        try {
            ...
            if(existsCheck.exists && existsCheck.book) {
                toast.info("A document with the same title already exists.");
                form.reset()
            ...
            if(!book.success) {
                toast.error(book.error as string || "Failed to create knowledge entry");
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="form-label">Source / Expert</FormLabel>
                                    <FormControl>
                                        <Input
                                            className="form-input"
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="form-label">Choose Expert Voice</FormLabel>
                                    <FormControl>
                                        <VoiceSelector
                                            value={field.value}
