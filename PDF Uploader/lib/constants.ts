...
// 11Labs Voice IDs mapped to SIX subject-matter experts (SMEs)
// Each persona represents a captured expert whose knowledge the AI speaks on behalf of
...
// Voice categories for the selector UI, grouped by SIX department
export const voiceCategories = {
    financialInformation: ['jacob', 'mirko', 'katharina'],
    innovationHub: ['jennifer', 'magdalena'],
};
